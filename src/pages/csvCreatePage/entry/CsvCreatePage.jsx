      ...
      <div className='csvCreate-field'>
        <div className='csvCreate-field__header'>
          <div className='csvCreate-field__title'>
            <div className='csvCreate-field__title--title'>CSV 생성 필드</div>
          ...
          <div className='csvCreate-field__condition'>
            <div className='csvCreate-field__condition--title'>필드 선택 기준</div>
            <div className='csvCreate-field__condition--info'>
